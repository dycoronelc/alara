  ...
  return (
    <div className="page">
      <div className="info-card">
        ...
        <p>Fuentes para investigaciones (n8n), integraciones y catálogos locales.</p>
        <p style={{ marginTop: '0.75rem', color: '#64748b', fontSize: '0.9rem' }}>
          Para gestionar <strong>roles</strong> y <strong>usuarios</strong> usa el menú lateral (solo administradores).
        </p>
      </div>
