...
export const defaultReportSections = (): ReportSectionDef[] => [
  ...
  },
  {
    ...
    title: 'Política',
    fields: [
      { key: 'pep', label: '¿Es PEP? (En caso de afirmativo dar detalles)', type: 'yes_no' },
      { key: 'pep_detail', label: 'Detalle PEP (cargo, organismo, etc.)', type: 'textarea' },
      {
        key: 'political_party',
        label: '¿Participa en partido político? (En caso de afirmativo dar detalles)',
        type: 'yes_no',
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'previous_rejected', label: '¿Solicitud rechazada anteriormente?', type: 'yes_no' },
      {
      ...
      { key: 'replaces_policy', label: '¿Reemplaza póliza actual?', type: 'yes_no' },
    ],
  },
  {
    code: 'INGRESOS',
  ...
  },
  {
    ...
    fields: [
      { key: 'dui', label: 'Condenas en los últimos 5 años', type: 'textarea' },
