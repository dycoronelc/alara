...
let AuthController = class AuthController {
    ...
    async serviceToken(req, payload) {
        if (req.userContext?.role !== 'ALARA' && req.userContext?.role !== 'ADMIN') {
            throw new common_1.ForbiddenException('Solo ALARA/ADMIN puede generar tokens de servicio');
        }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, service_token_dto_1.ServiceTokenDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "serviceToken", null);
