    ...
    sections: [
      {
        ...
        order: 1,
        fields: [
          { key: 'first_name', label: 'Nombres', type: 'TEXT', value: '' },
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'weight_unit', label: 'Unidad de peso', type: 'ENUM', value: '' },
          { key: 'height', label: 'Altura', type: 'TEXT', value: '' },
          { key: 'height_unit', label: 'Unidad de altura', type: 'ENUM', value: '' },
  ...
  const [insurerUser1, insurerUser2, alaraUser, adminUser, brokerUser] = await prisma.$transaction([
    ...
    prisma.user.create({
      data: {
        ...
        phone: '+507 6000 0202',
        full_name: 'Roberto Corredor',
        password_hash: await hashPassword('Broker123!'),
      },
    }),
  ]);
